...
VERIFY_SYSTEM = (
    ...
    "value, and a value_type of 'absolute' -- meaning the passage states this is the CURRENT "
    "TOTAL --, 'delta' -- meaning the passage states this is a flat-number CHANGE/BONUS/POINTS "
    "ADDED, not a total --, or 'percentage' -- meaning the passage states the bonus as a PERCENT, "
    "e.g. '+5% to Constitution', not a flat number. A percentage bonus is a genuinely different "
    "quantity than a flat delta of the same number -- '+5%' is NOT interchangeable with '+5'.\n\n"
    "SPECIAL CASE -- value=null claims: some claims have value=null and value_type=null. This is a "
    "VALID, NORMAL outcome, not a defect: it means a skill/ability is named in the passage with no "
    "accompanying number. Mark these VALID as long as the passage does in fact name that skill/"
    "ability -- do not reject a null-value claim just because it lacks a number; a missing number "
    "was never claimed to exist in the first place, so there's nothing to fact-check about the value.\n\n"
    ...
    "stated in the passage at all, the value_type is wrong (e.g. a '+N to X' flat bonus phrase was "
    "labeled absolute, a percentage phrase like '+N% to X' was labeled delta or absolute instead of "
    "percentage, or a 'X was now N' total phrase was labeled delta), the stat/skill name doesn't "
    "match what's described, or the claim reads more into the passage than it actually says.\n\n"
